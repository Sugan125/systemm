            ...
            <div class="row">
                <div class="col-md-12 col-xs-12">
                    ...
                    <div class="box">
                        ...
                        <form action="<?php echo base_url('index.php/orders/showpacking/'); ?>" method="post" target="_blank" style="display: inline-block;">
                            ...
                            <button type="submit" class="btn btn-danger"><i class="fas fa-print"></i> <b>DOWNLOAD PACKING LIST</b></button>
                        </form>
