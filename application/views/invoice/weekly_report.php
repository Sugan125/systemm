...
<div class="container d-flex justify-content-center align-items-center vh-100">
    <div class="row w-100 justify-content-center">
        <div class="col-md-6">
            <div class="box">
                <h5 class="box-title"><b>SALES SUMMARY ITEM WISE WEEKLY REPORT</b></h5>
    ...
    <div class="form-group">
        ...
        <input type="date" hidden id="start_date" name="start_date" class="form-control" required 
               value="<?php echo $weekStart; ?>" >
    </div>
    <br>
    <div class="form-group">
        
        <input type="date" hidden id="end_date" name="end_date" class="form-control" required 
