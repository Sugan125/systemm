...
class Dashboardcontroller extends CI_Controller{
 ...
 function action()
 {
     ...
     // Leave 1 empty row after header
     $excel_row += 2;
     ...
     // Leave 2 empty rows after address
     $excel_row += 3;
     ...
     // Leave one empty row after headers
     $excel_row += 2;
 
     // Start headers from column B
     $table_columns = array(
         "Product ID",
         "Product Name",
         "Company Name",
     ...
     foreach ($grouped_data as $key => $rows) {
         ...
         foreach ($company_grouped_data as $company_name => $data) {
             ...
             // Set cell values and then adjust alignment
