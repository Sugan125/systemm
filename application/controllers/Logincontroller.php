        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            if ($status != false) {
                $userData = array(
					...
					'address_line2' => $status->address_line2,
					'address_line3' => $status->address_line3,
					'address_line4' => $status->address_line4,
					'address_city' => $status->address_city,
					'address_postcode' => $status->address_postcode,

					'delivery_address' => $status->delivery_address,
					'delivery_address_line2' => $status->delivery_address_line2,
					'delivery_address_line3' => $status->delivery_address_line3,
					'delivery_address_line4' => $status->delivery_address_line4,
					'delivery_address_city' => $status->delivery_address_city,
					'delivery_address_postcode' => $status->delivery_address_postcode,

					'address2' => $status->address2,
					'address2_line2' => $status->address2_line2,
					'address2_line3' => $status->address2_line3,
					'address2_line4' => $status->address2_line4,
					'address2_city' => $status->address2_city,
					'address2_postcode' => $status->address2_postcode,

					'address3' => $status->address3,
					'address3_line2' => $status->address3_line2,
					'address3_line3' => $status->address3_line3,
					'address3_line4' => $status->address3_line4,
