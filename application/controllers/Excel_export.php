 ...
 function action()
{
    ...
    foreach ($employee_data as $row) {
        ...
        if ($row->name != $prev_name && $prev_name != '__INITIAL_VALUE__') {
            if ($delivery_charge_count > 0) {
                ...
                if ($average_delivery_charge > 0) {
                    ...
                    $object->getActiveSheet()->setCellValueByColumnAndRow(14, $excel_row, $del_inc_tax);
                    ...
                    $object->getActiveSheet()->setCellValueByColumnAndRow(17, $excel_row, $average_delivery_charge);
                    $object->getActiveSheet()->setCellValueByColumnAndRow(18, $excel_row, 'Sale;'.$row->sales_person);
                    $object->getActiveSheet()->setCellValueByColumnAndRow(21, $excel_row, $row->sales_person);
                    ...
                    $object->getActiveSheet()->setCellValueByColumnAndRow(24, $excel_row, $del_gst);
                }
                $excel_row++; // Increment the row counter
        ...
        $object->getActiveSheet()->setCellValueByColumnAndRow(14, $excel_row, $inc_tax);
        $object->getActiveSheet()->setCellValueByColumnAndRow(15, $excel_row, '0');
        $object->getActiveSheet()->setCellValueByColumnAndRow(16, $excel_row, $row->amount);
        $object->getActiveSheet()->setCellValueByColumnAndRow(17, $excel_row, $net_total);
        $object->getActiveSheet()->setCellValueByColumnAndRow(18, $excel_row, 'Sale;'.$row->sales_person);
        $object->getActiveSheet()->setCellValueByColumnAndRow(19, $excel_row, $row->driver_memo);
        $object->getActiveSheet()->setCellValueByColumnAndRow(21, $excel_row, $row->sales_person);
        $object->getActiveSheet()->setCellValueByColumnAndRow(22, $excel_row, $delivery_date);
        $object->getActiveSheet()->setCellValueByColumnAndRow(23, $excel_row, 'SR9');        $object->getActiveSheet()->setCellValueByColumnAndRow(24, $excel_row, $row->gst_amount);
        $object->getActiveSheet()->setCellValueByColumnAndRow(25, $excel_row, $row->payment_terms);
    ...
    if ($delivery_charge_count > 0) {
        ...
        if ($average_delivery_charge > 0) {
            ...
            $object->getActiveSheet()->setCellValueByColumnAndRow(10, $excel_row, "Delivery Service");
            $object->getActiveSheet()->setCellValueByColumnAndRow(11, $excel_row, $average_delivery_charge);
            $object->getActiveSheet()->setCellValueByColumnAndRow(12, $excel_row, 'Delivery charge');
